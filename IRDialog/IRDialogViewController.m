...
@property (strong, nonatomic) IRPickerViewController      *picker;
@property (strong, nonatomic) IRDatePickerViewController  *datePicker;
@end
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
  ...
  UIView *customView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, self.view.frame.size.width, 100.0)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
  ...
  if ([self.rows[indexPath.section][indexPath.row][1] isEqualToString:@"picker-state"]){
    ...
    self.picker = [[IRPickerViewController alloc]
    ...
    self.datePicker = [[IRDatePickerViewController alloc] initWithSelectedDate:birthdate datePickerMode:UIDatePickerModeDate];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(xOffset, yOffset, width, cell.frame.size.height-5)];
